...
contract EpochManage is IEpochManage, Initializable {
    ...
    //update price list every hour
    //store the nearest 12h prices
    function updatePriceList() external {
        ...
        require(block.timestamp.sub(lastPriceUpdateTime)>=3600);//update only 1 time in 1 hour
